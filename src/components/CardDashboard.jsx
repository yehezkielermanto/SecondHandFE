...
const CardDashboard = () => {
  ...
  // };
  // console.log(product.product.data.totalBarang);
          ...
          <div className="flex justify-center">
            ...
            >
              <div className="inline-block m-1 border border-gray-300 p-1 rounded-lg">
                ...
                <h3 className="font-semibold">{product.data.barang.nama}</h3>
                <p>{product.data.barang.deskripsi}</p>
                <h3 className="font-semibold">{product.data.barang.harga}</h3>
              </div>
              {/* <div className="inline-block m-1 border border-gray-300 p-1 rounded-lg">
