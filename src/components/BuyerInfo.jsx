...
export default function BuyerInfo(props) {
    ...
    return (
                      ...
                      <div>
                          <div className="flex gap-4 py-3">
                              ...
                              <div className={`${isAcceptProduct? 'hidden' : 'grid'} grid-cols-2 lg:float-right text-center pt-4 pb-4`}>
                                  <button className="mr-2 px-[48px] py-2 inline-block bg-white border border-[#7126B5] hover:bg-gray-200 text-black hover:text-white font-normal text-sm leading-tight rounded-[16px] 
                                  ...
                                  <button className="ml-2 px-[48px] py-2 inline-block bg-[#7126B5] hover:bg-[#8f48cf]  text-white font-normal text-sm leading-tight rounded-[16px] 
                              ...
                              <div className={`${isAcceptProduct? 'grid' : 'hidden'} grid grid-cols-2 lg:float-right text-center pt-4 pb-4`}>
                                  <button className="flex items-center justify-center mr-2 px-8 py-2 bg-white border border-[#7126B5] hover:bg-gray-200 font-normal text-sm leading-tight rounded-[16px] 
                                  ...
                                  <button className="flex items-center justify-center ml-2 px-8 py-2 bg-[#7126B5] hover:bg-[#8f48cf]  text-white font-normal text-sm leading-tight rounded-[16px] 
      ...
      <div onClick={handleCloseModal} className={`w-screen h-screen fixed ${isModalShow?'flex':'hidden'} items-center justify-center bg-black bg-opacity-70 top-0 left-0 z-50`}>
          ...
          {/* Modal for Tolak */}
          <div onClick={(e)=>e.stopPropagation()} className={`${isModalDeniedShow?'bg-white':'hidden'}  lg:relative absolute bottom-0 p-6 w-full max-w-sm md:h-auto rounded-2xl`}>
              ...
              <button onClick={handleCloseModal} className="flex items-center justify-center  py-2 bg-[#7126B5] hover:bg-[#8f48cf] text-white font-normal text-sm rounded-[16px] 
          ...
          {/* Modal for Status */}
          <div onClick={(e)=>e.stopPropagation()} className={`${isModalStatusShow?'bg-white':'hidden'} lg:relative absolute bottom-0 p-6 w-full max-w-sm md:h-auto rounded-2xl`}>
              <button className='float-right'>
                  <FiX onClick={handleCloseModal} className='text-xl mb-2' />
              </button>
              <p className='text-sm font-medium pb-2 pt-8'>
              ...
              <div className='pt-6'>
                  <div className="flex pb-3">
                      <div className="items-center h-5">
                          <input checked id="radio1" name="status" type="radio" value="" className="accent-[#7126B5] bg-[#C4C4C4] rounded border-[#C4C4C4] focus:ring-[#C4C4C4] focus:ring-2" />
                      </div>
                  ...
                  <div className="flex">
                      <div className="items-center h-5">
                          <input id="radio2" name="status" type="radio" value="" className="accent-[#7126B5] bg-[#C4C4C4] rounded border-[#C4C4C4] focus:ring-[#C4C4C4] focus:ring-2" />
                      </div>
                      <div className="ml-3 text-sm">
