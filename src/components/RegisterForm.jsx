       ...
       <section className="h-full text-left">
            ...
            <div className="lg:w-6/12 w-full px-4 md:px-0 items-center my-8">
                ...
                <form>
                    ...
                    <div className="mb-5">
                    <Input.Password
                        type="password" className="form-control px-4 py-2 font-normal text-base text-neutral-3 bg-white 
                        border-neutral-2 rounded-[16px] transition ease-in-out m-0 focus:text-gray-700 focus:outline-none"
                    ...
                    <p className="md:mb-5  md:pt-0">Sudah punya akun?
                        <Link to="/login" >
                        <button className="text-[#7126B5] hover:text-sky-400 font-semibold pl-1 
