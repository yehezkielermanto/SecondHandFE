      ...
      <div className="pb-5 px-4 mt-2 mb-10 md:max-w-screen-lg md:mt-4 md:mx-auto md:px-0 md:pb-0 ">
        <div className="w-full relative md:w-3/5 md:flex-shrink-0 p-4 rounded-lg shadow-[0px_0px_4px_rgba(0,0,0,0.15)] bg-white mt-5">
          ...
          <p className="text-sm font-regular lg:leading-tight leading-normal text-[#8A8A8A] dark:text-[#8A8A8A]">
            ...
            vestibulum tortor. Pellentesque tristique augue lorem, eget lacinia
            diam rutrum in. In pretium lacus vel dolor finibus, nec molestie
            sapien condimentum. Morbi mollis hendrerit eros quis viverra. Donec
            augue magna, mattis id lectus id, congue venenatis odio. Ut a
            consectetur eros. Phasellus convallis convallis vestibulum.
            Curabitur fermentum dolor quam, vitae ultricies sem facilisis eget.
            Suspendisse et blandit ex. Nullam libero orci, placerat sed posuere
            pretium, vestibulum quis tellus. Maecenas ut massa auctor, mollis
            nulla non, consectetur augue. Morbi malesuada vulputate dolor ac
            tempus. Cras nec nisl tincidunt, venenatis eros quis, tincidunt
            dolor. Nulla facilisi. Fusce at luctus risus.
          </p>
